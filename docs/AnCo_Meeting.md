...
**아직 번역 미적용 페이지** (다음 패스에서 작업 예정):
- `/teatime` (티타임 대화)
- `/feed`, `/my`, `/newsletter`, `/profile`, `/feedback`
...
**뭐 확인해주세요?**
*대표님이 뭘 의미하셨는지 명확하지 않음 — 아래 중 어떤 건지 체크 표시:*
- [ ] 사용자가 소식지/티타임 외관을 본인이 직접 편집하는 기능?
- [ ] 관리자가 디자인 테마 바꾸는 기능?
- [ ] 다른 의미?

구체적으로 알려주시면 코부장이 바로 작업 들어가겠습니다.
